...
import com.mobiquity.entity.ParsedLine;
...
public class Packer {
  ...
  public static String pack(String inputPath) throws APIException {
    return parseInput(inputPath).stream()
            .map(parsedLine -> getCombinations(parsedLine.getMaxWeight(), parsedLine.getPackages()))
            .collect(Collectors.joining("\n"));
  }

  private static List<ParsedLine> parseInput(String inputPath) throws APIException {
  ...
  private static String getCombinations(int maxWeight, List<Package> packages) {
